...
export const checkAuth = (user) => (dispatch) => api.user.checkAuth(user).then(user => {localStorage.setItem('User', JSON.stringify(user.data)); dispatch(authCheck(user.data))});